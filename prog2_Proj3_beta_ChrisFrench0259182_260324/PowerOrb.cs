...
public class PowerOrb : Collectable
    {
        ...
        public PowerOrb(string Name, int x, int y, int count, char symbol, ConsoleColor color, (int, int) min_max_x, (int, int) min_max_y) : base(Name, x, y, count: 6, symbol: '$', ConsoleColor.Yellow, min_max_x, min_max_y)
        {
            Name = "Power Orb";
            powerOrb_x_pos = x;
            powerOrb_y_pos = y;
